...
overall_results = {'NB' : []} #{'LSVC': [],'MNB': [], 'LR': [], 'PT': []}

classifiers = {
    'MNB' : [MultinomialNB(), {'fit_prior': (True, False)}],
    'LR' : [LogisticRegression(), {'max_iter' : (50, 100)}],
    'LSVC': [LinearSVC(), {'max_iter': (100, 400, 1000)}],
    'DT' : [DecisionTreeClassifier(), {'max_depth':(10, 15)}],
    'PT' : [Perceptron(), {'max_iter': (100, 1000)}],
    'NB' : [KNeighborsClassifier(), {'n_neighbors' : (2, 3, 5, 8, 10, 12) }]
}
